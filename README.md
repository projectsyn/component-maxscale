# Commodore Component: MariaDB MaxScale

This is a [Commodore][commodore] Component for MariaDB MaxScale.
...
The rendered documentation for this component is available on the [Commodore Components Hub](https://hub.syn.tools/maxscale).
